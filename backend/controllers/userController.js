...
const updateProfile = async (req, res) => {
    ...
    try {
        ...
        const userId = req.userId       // this we will get from authUser
...
const bookAppointment = async (req, res) => {
    ...
    try {
        ...
        const userDataToSave = userData.toObject()
...
const verifyRazorpay = async (req,res) => {
    try{
        ...
        if(orderInfo.status === 'paid'){    // reciept = orderID
