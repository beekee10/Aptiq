            ...
            <div className='bg-white border rounded text-sm overflow-y-scroll'>
                ...
                {/* Data Mapping */}
                {
                    appointments.reverse().map((item, index) => (
                        <div key={index} className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center py-3 px-6 border-b hover:bg-gray-50'>
