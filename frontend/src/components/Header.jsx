...
const Header = () => {
  return (
    <div className='flex flex-col pt-30 md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10'>
      {/* Left side*/}
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30] '>
        ...
        <div className='flex flex-col md:flex-row items-center gap-3 text-white text-md font-medium'>
            <img className='w-28' src={assets.group_profiles} alt="" />
            <p>Simply browse through our extensive list of trusted doctors,<br className='hidden sm:block' />
            schedule your appointment hassle-free</p>
        </div>
        <a href='#speciality' className='flex items-center gap-2 px-8 py-3 rounded-full text-gray-700 bg-white w-50 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300'>
