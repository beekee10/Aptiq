...
const MyAppointments = () => {
  ...
  const initPay = (order) => {
    ...
    const options = {
      ...
      order_id: order.id,
      receipt: order.receipt,   // ✅ fixed typo
      ...
      <div>
        ...
        {appointments.map((item, index) => (
          ...
          >
            ...
            <div>
              <img
                className='w-40 bg-indigo-50 h-auto object-cover'
            ...
            <div className='flex flex-col gap-2 justify-end'>
              ...
              {!item.cancelled && item.payment && !item.isCompleted && (
                <button className='text-sm text-white sm:min-w-48 py-2 border rounded bg-green-500'>
                  Paid
                </button>
              )}
              ...
              {item.cancelled && !item.isCompleted && (
                <button className='text-sm text-white sm:min-w-48 py-2 border rounded bg-red-500'>
